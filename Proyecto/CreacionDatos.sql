...
INSERT INTO Mascotas (id, nombre, raza, edad, descripcion, foto, estado, usuario) 
VALUES (4, 'Chispas', 'Perico Verde', 1, 'Muy juguetón y parlanchón', 
...
INSERT INTO Mascotas (id, nombre, raza, edad, descripcion, foto, estado, usuario) 
VALUES (6, 'Toby', 'Bulldog Inglés', 3, 'Le encanta jugar con agua y es muy cari�oso', 
'https://www.mercafauna.com/fotos/animales/28_bulldog_ingles05.jpg', 
'Adoptado', 2);

--4. Insertar historial médico
...
--11. Insertar asistencias a eventos
...
--13. Insertar actividades de voluntarios
